...
L.marker([33.109576, -116.672355], {icon: L.AwesomeMarkers.icon({icon: 'gas-pump', prefix: 'fa', markerColor: 'gray', spin:false}) }).bindPopup("<b>The Chairs:</b><br>Gas Station<br>popular Motorcycle stop<br><a target='_blank' href='https://goo.gl/maps/e5EQj5hFFKrvSQrk6'>Google Maps</a>"),
L.marker([32.837706, -117.134908], {icon: L.AwesomeMarkers.icon({icon: 'warehouse', prefix: 'fa', markerColor: 'black', spin:false}) }).bindPopup("<b>BMWMCSD:</b><br>BMW Motorcycles San Deigo<br><a target='_blank' href='https://goo.gl/maps/Ha9UfZS7C8CiqnFz9'>Google Maps</a>"),
...
L.marker([33.119596, -117.102446], {icon: L.AwesomeMarkers.icon({icon: 'warehouse', prefix: 'fa', markerColor: 'black', spin:false}) }).bindPopup("<b>BMW Escondido</b><br>BMW Motorcycles Escondido<br><a target='_blank' href='https://goo.gl/maps/HoywKuSX3D91RwtL7'>Google Maps</a>"),
...
L.marker([33.314333, -116.865386], {icon: L.AwesomeMarkers.icon({icon: 'utensils', prefix: 'fa', markerColor: 'gray', spin:false}) }).bindPopup("<b>Mother's Kitchen</b><br>Popular Motorcycle spot<br><a target='_blank' href='https://goo.gl/maps/j1FqQYcFTpWVv25M8'>Google Maps</a>"),
